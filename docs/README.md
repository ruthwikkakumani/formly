...
| Doc | What it covers |
|---|---|
| [LLD](./lld.md) | Layers, modules, APIs, key classes, request flow |
...
| [Component & deployment](./diagrams/component.md) | Frontend/backend packages + hosting |

Render these on GitHub — Mermaid is native in `.md` files.
